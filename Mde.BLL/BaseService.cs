...
namespace Mde.BLL
{
    public abstract class BaseService<T> where T : class,new()
    {
        ...
        {
            return CurrentRepository.FindEntities(id);
        }
        ...
        //
        public int ExecProcedure(string procedureNm, DbParameter[] parameters)
        {
            return _dbSession.ExcuteSql(procedureNm, parameters);
        }
