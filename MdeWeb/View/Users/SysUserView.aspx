<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysUserView.aspx.cs" Inherits="DatapoolWeb.View.Users.SysUserView" %>
...
<body class="wsd_option_area">
    <form id="form1" runat="server">
        <table id="wsd_title">
            <tr>
                ...
                <td class="wsd_titlefont1">
                    <asp:Literal ID="Literal2" runat="server" Text="系统用户查看"></asp:Literal>
                </td>
            </tr>
        </table>
        <br />
        <table id="wsd_inputtable">
            ...
            <tr height="40px">
                <td class="tablefield">人员名称</td>
                <td nowrap="nowrap">
                    <asp:TextBox ID="txtPersonName" runat="server" Width="124px"></asp:TextBox>
                </td>
                <td class="tablefield">人员编码
                </td>
                <td nowrap="nowrap">
                    <asp:TextBox ID="txtUserCode" runat="server" Width="124px"></asp:TextBox>
                </td>
        ...
        <table id="wsd_inputtable">
            <tr>
                <td class="tabletitle" style="height: 21px" width="100%">系统用户列表
                </td>
            </tr>
        </table>
                    ...
                    <asp:GridView Width="100%" ID="gvUserList" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="人员名称">
                                <ItemTemplate>
                                    <a href="SysUserEdit.aspx?id=<%#Eval("ID") %>">
                                        <%#Eval("PERSON_NM")%></a>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="人员编码" DataField="CODE" />
                            <asp:BoundField HeaderText="组织" DataField="GROUP_NM" />
                              <asp:TemplateField HeaderText="有效性" ItemStyle-HorizontalAlign="center" HeaderStyle-HorizontalAlign="center">
                                <ItemTemplate>
                                    <b><%# (string)Eval("VALID")=="1" ? "<font size='3' color='green'>√</font>" : "<font size='3' color='red'>×</font>"%></b>
                                </ItemTemplate>
