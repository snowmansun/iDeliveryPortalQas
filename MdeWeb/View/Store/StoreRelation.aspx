<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreRelation.aspx.cs" Inherits="DatapoolWeb.View.Store.StoreRelation" %>
            ...
            <ContentTemplate>
                <div>
                    ...
                    <table id="wsd_inputtable">
                        ...
                        <tr>
                            <td class="tablefield">业代类型</td>
                            <td nowrap="nowrap">
                                <asp:DropDownList ID="ddlSRType" runat="server" AutoPostBack="True"
                                    Width="130px">
                                </asp:DropDownList>
                            </td>
                            <td class="tablefield">SR</td>
                            <td nowrap="nowrap">
