<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreRelationDSMAdd.aspx.cs" Inherits="DatapoolWeb.View.Store.StoreRelationDSMAdd" %>
    ...
    function ExistsCustomer(_obj, _bIsChecked) {
        ...
        if (_chk) {
            ...
            $(_obj).parent().parent().each(function () {
                ...
                var _sr = $(this).children('td').eq(6).text();//获取SR
